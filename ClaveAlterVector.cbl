      ...
      ******************************************************************
       ...
       77  no-encontre-socio pic 9 value 0.
       01  tabla-socios.
           03 largo pic 99.
       ...
       235-VALIDAR-OPCION.
           PERFORM UNTIL w-opcion > 0 AND w-opcion < 4
       ...
       300-PROCESO-MENU.
           EVALUATE w-opcion
               WHEN 1 PERFORM 330-LEER-POR-NUM
               WHEN 2 PERFORM 350-LEER-POR-NOM
           END-EVALUATE.

       330-LEER-POR-NUM.
           MOVE ZERO TO no-encontre-socio
           PERFORM 360-PIDO-NUM.
           PERFORM 363-BUSCO-SOCIO.
           IF no-encontre-socio IS EQUALS ZERO THEN
               PERFORM 335-MOSTRAR-DATOS
           END-IF.

       364-INGRESO-NUMERO.
           PERFORM 360-PIDO-NUM.
           PERFORM 366-VALIDAR-NUMERO.
       ...
       363-BUSCO-SOCIO.
           READ SOCIOS INVALID KEY
                           ...
                           MOVE 1 TO no-encontre-socio.

       366-VALIDAR-NUMERO.
           PERFORM UNTIL soc-nro IS NOT EQUALS " "
               DISPLAY "ERROR"
               PERFORM 360-PIDO-NUM
           END-PERFORM.
